...
Turn your real AI usage into a tiny desktop companion that hatches, evolves, and bonds with you — and recaps what you actually learned each day. Works even if you only use web-based AI.
...
- **Grow yourself, not just the pet** — the **Growth Journal** hands you what's worth learning (explained), the to-dos you mentioned (editable), and a daily history. **No Claude Code / Codex required** — paste one prompt into whatever AI you're already using and bring its answer back.
...
| 🧠 Growth Journal | Takeaways, editable to-dos, daily history — auto via your local CLI, or borrow any AI you use (drag / ⌘⇧V it back) |
...
Burning tokens shouldn't mean outsourcing your brain. Open the **Growth Journal** and your sprite reviews today's AI-coding chats — through *your own local Claude / Codex* — and gives you back:

- **Takeaways** — the concepts you leaned on, actually explained, so you learn them.
- **To-dos** — things you said you'd do (commit, add tests, book a flight), editable and one-tap done; regenerating refreshes them without overwriting what you touched.
- **Daily history** — it all persists locally, building a trail of how you grow.

Everything runs through the AI you already use; nothing is uploaded to a third party.

<p align="center">
<img src="assets/readme/growth-journal-en.png" width="640" alt="Growth Journal: today's takeaways, editable to-dos, and daily history" />
</p>

### 🍃 No CLI installed? Still works

Only use web-based AI (Doubao, ChatGPT, whatever)? Borrow its own strength:

1. Click **Copy prompt** in the Growth Journal
2. Paste it into the AI you're already chatting with
3. Bring its answer back — press **⌘⇧V** or **drop it on the sprite**

Its context already holds today's conversation, so **you never copy the chat itself** — just bring the answer back and it lands straight in your journal.

### 🥢 Feed it anything

Spot something worth keeping? **Select and drag it onto the sprite**, or copy it and hit **⌘⇧V**. It holds onto those until the next recap, then digests them together with the day's chats.

> The shortcut reads your clipboard **only at the moment you press it** — never in the background. Watching your clipboard around the clock would mean reading every password and private message you copy; not worth it.
